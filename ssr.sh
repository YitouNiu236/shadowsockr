...
Download_SSR(){
        cd "/usr/local/"
	wget -N --no-check-certificate "https://raw.githubusercontent.com/YitouNiu236/shadowsockr/master/manyuser.zip"
...
Service_SSR(){
        if [[ ${release} = "centos" ]]; then
                if ! wget --no-check-certificate https://raw.githubusercontent.com/YitouNiu236/shadowsockr/master/ssr -O /etc/init.d/ssr; then
